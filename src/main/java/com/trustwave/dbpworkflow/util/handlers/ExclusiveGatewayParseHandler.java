...
import static org.flowable.engine.delegate.BaseExecutionListener.EVENTNAME_TAKE;
 ...
 * @author sfreytag
 */
public class ExclusiveGatewayParseHandler extends AbstractBpmnParseHandler<ExclusiveGateway> {
    ...
    @Override
    protected void executeParse(BpmnParse bpmnParse, ExclusiveGateway element) {
