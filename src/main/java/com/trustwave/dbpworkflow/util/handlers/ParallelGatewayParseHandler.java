 ...
 * @author sfreytag
 */
public class ParallelGatewayParseHandler extends AbstractBpmnParseHandler<ParallelGateway> {
    ...
    @Override
    protected void executeParse(BpmnParse bpmnParse, ParallelGateway element) {
